...
-- This gives the # of unique category rows (COUNT = number)
SELECT COUNT (DISTINCT category) as total_sale FROM retail_sales

-- This gives List of unique categories (e.g., Clothing, Beauty, Electronics)
...
SELECT 
	category,
	COUNT(DISTINCT customer_id) as purchased_amount
	FROM retail_sales
	GROUP BY category
	
-- Write a SQL query to create each shift and numbers of orders (Morning <12, Afternoon between 12 and 17 and Evening >17) 
WITH hourly_sale
AS
(SELECT *,
	CASE
